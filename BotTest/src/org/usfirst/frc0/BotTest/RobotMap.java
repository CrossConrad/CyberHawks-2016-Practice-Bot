...
public class RobotMap {
    ...
    public static void init() {
        ...
        clawBottomLimit = new DigitalInput(1);
        LiveWindow.addSensor("Claw", "BottomLimit", clawBottomLimit);
        
        clawTopLimit = new DigitalInput(0);
        ...
        elevatorElevatorVertical = new Talon(3);
