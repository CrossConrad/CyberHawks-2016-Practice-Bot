...
public class OI {
    ...
    public JoystickButton clawOpener(RB);
    public JoystickButton clawUp(Y);
    public JoystickButton clawDown(X);
    public JoystickButton elevatorUp(B);
    public JoystickButton elevatorDown(A);
    ...
    public OI() {
        ...
        elevatorDown(A) = new JoystickButton(xbox, 1);
        elevatorDown(A).whileHeld(new ElevatorDownC());
        elevatorUp(B) = new JoystickButton(xbox, 1);
        elevatorUp(B).whileHeld(new ElevatorUpC());
        clawDown(X) = new JoystickButton(xbox, 1);
        clawDown(X).whileHeld(new ClawDownC());
        clawUp(Y) = new JoystickButton(xbox, 1);
        clawUp(Y).whileHeld(new ClawUpC());
        clawOpener(RB) = new JoystickButton(xbox, 1);
        clawOpener(RB).whileHeld(new ClawOpenerC());
